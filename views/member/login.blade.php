      ...
      <div class="row">
         <div class="col-md-6">
            <div class="reg-login-info">
               ...
               <h3>New Customer</h3>
               <p>By creating an account you will be able to shop faster, be up to date on an order's status, and keep track of the orders you have previously made.</p><br><a href="{{URL::to('member/create')}}" class="btn btn-danger">Create Account</a>
                     ...
                     {{Form::open(array('url'=>'member/login','method'=>'post','class'=>'form-horizontal'))}}
                       ...
                       <div class="form-group">
                         ...
                         <div class="col-lg-10">
                           ...
                           <a href="{{URL::to('member/forget-password')}}" style="font-size: smaller;float: right;">Have you forget your password?</a>
                         </div>
                       </div>
                       <!-- <div class="form-group">
