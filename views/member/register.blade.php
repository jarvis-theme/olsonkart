      ...
      <div class="row">
         <div class="col-md-6">
            <div class="reg-login-info">
               ...
               <p>By login you will be able to shop faster, be up to date on an order's status, and keep track of the orders you have previously made.</p><br><a href="{{URL::to('member/')}}" class="btn btn-danger">Login</a>
