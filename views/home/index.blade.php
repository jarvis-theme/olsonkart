        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          <div class="item">
            ...
            <div class="item-details">
              ...
              <!-- Add to cart -->
              <div class="pull-right"><a href="{{slugProduk($myproduk)}}" class="btn btn-danger btn-sm">Lihat Produk</a></div>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
                ...
                <div class="my_carousel">
                  ...
                  <div class="clearfix"></div>
                   <ul id="carousel_container">
                      ...
                      <li>
                         <a href="{{slugProduk($myproduk)}}"><img style="width: auto" src="{{URL::to(getPrefixDomain().'/produk/'.$myproduk->gambar1)}}" alt="" class="img-responsive"/></a>
