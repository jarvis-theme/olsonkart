                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6">
                          <div class="item">
                            ...
                            <div class="item-image">
                              <a href="{{slugProduk($myproduk)}}">{{HTML::image(url(product_image_url($myproduk->gambar1)), $myproduk->nama, array('class="img-responsive" style="width:auto"'))}}</a>
                            </div>
                            <!-- Item details -->
                  ...
                  <div class="sidey">
                     <ul class="nav">
                        ...
                        @foreach (list_category() as $kat)
                            @if($kat->parent=='0')
                                <li><a href="{{url(category_url($kat))}}">{{shortName($kat->nama,20)}}</a>
									@if($kat->anak->count())
										<ul id="<?php echo strtolower($kat->nama);?>" >
										@foreach(list_category() as $kat2)
											@if ($kat2->parent==$kat->id)
												<li><a href="{{url(category_url($kat2))}}" class="active" style="text-decoration: none;">{{$kat2->nama}}</a>
												</li>
											@endif
										@endforeach
										</ul>
                  ...
                  <!-- Sidebar items (featured items)-->
                   ...
                   <div class="sidebar-items">
                     ...
                     <div class="sitem">
                       <div class="onethree-left">
                         <!-- Image -->
                         <a href="{{koleksi_url($kol)}}">{{ HTML::image(url(koleksi_image_url($kol)),$kol->nama, array('class' => 'img-responsive' ))}}</a>
                       </div>
                   ...
                   <div class="special" style="text-align:center;">
                         @foreach(vertical_banner() as $item)
                          <div><a href="{{URL::to($item->url)}}"><img width="213" src="{{url(banner_image_url($item))}}" /></a></div>
                        @endforeach
                    </div>
                    <br>
                    <div class="form">
