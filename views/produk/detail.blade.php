                          ...
                          <div class="item-image" id="flexslider-product">
							...
							@if($produk->gambar1!='')
								<div class="col-md-3 slides">
									<a  href="{{URL::to(getPrefixDomain().'/produk/'.$produk->gambar1)}}"><img class="img-responsive" style="float: left; width:75px !important;list-style-type: none;" src="{{URL::to(getPrefixDomain().'/produk/thumb/'.$produk->gambar1)}}"  alt="{{$produk->nama}}"></a>
								</div>
							@endif
							@if($produk->gambar2!='')
								<div class="col-md-3 slides">
									<a  href="{{URL::to(getPrefixDomain().'/produk/'.$produk->gambar2)}}"><img class="img-responsive" style="float: left; width:75px !important;list-style-type: none;" src="{{URL::to(getPrefixDomain().'/produk/thumb/'.$produk->gambar2)}}" alt="{{$produk->nama}}"></a>
								</div>
							@endif
							@if($produk->gambar3!='')
								<div class="col-md-3 slides">
									<a  href="{{URL::to(getPrefixDomain().'/produk/'.$produk->gambar3)}}"><img class="img-responsive" style="float: left; width:75px !important;list-style-type: none;" src="{{URL::to(getPrefixDomain().'/produk/thumb/'.$produk->gambar3)}}" alt="{{$produk->nama}}"></a>
								</div>
							@endif
                          </div>
