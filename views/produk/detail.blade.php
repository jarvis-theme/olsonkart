                      ...
                      <div class="row">
                        <div class="col-md-5 col-xs-5" style="text-align: center;">
                          ...
                          <div class="item-image" id="flexslider-product">
							<img style="margin:0" src="{{URL::to(product_image_url($produk->gambar1))}}" class="img-responsive" alt="{{$produk->nama}}">
							@if($produk->gambar1!='')
								<div class="col-md-3 slides">
									<a  href="{{URL::to(product_image_url($produk->gambar1))}}"><img class="img-responsive" style="float: left; width:75px !important;list-style-type: none;" src="{{URL::to(product_image_url($produk->gambar1))}}"  alt="{{$produk->nama}}"></a>
								</div>
							@endif
							@if($produk->gambar2!='')
								<div class="col-md-3 slides">
									<a  href="{{URL::to(product_image_url($produk->gambar2))}}"><img class="img-responsive" style="float: left; width:75px !important;list-style-type: none;" src="{{URL::to(product_image_url($produk->gambar2))}}" alt="{{$produk->nama}}"></a>
								</div>
							@endif
							@if($produk->gambar3!='')
								<div class="col-md-3 slides">
									<a  href="{{URL::to(product_image_url($produk->gambar3))}}"><img class="img-responsive" style="float: left; width:75px !important;list-style-type: none;" src="{{URL::to(product_image_url($produk->gambar3))}}" alt="{{$produk->nama}}"></a>
								</div>
							@endif
                          </div>
                        ...
                        <div class="col-md-5 col-xs-7" style="">
                          <!-- Title -->
                            <h4>{{$produk->nama}}</h4>
                            <h5><strong>Harga : 
                            @if($produk->hargaCoret!='' || $produk->hargaCoret!='0')
                    ...
                    <div id="myTabContent" class="tab-content">
                      ...
                      <div class="tab-pane fade" id="tab3">
                        ...
                        <div class="item-review">
                          {{$fbscript}}
							{{fbcommentbox(product_image_url($produk), '640px', '5', 'light')}}
                        </div>
               ...
               <div class="col-md-3 col-md-pull-9">
                  <div class="sidey">
                     <ul class="nav">
                        ...
                        @foreach (list_category() as $kat)
                            @if($kat->parent=='0')
                                <li><a href="{{URL::to(category_url($kat))}}">{{shortName($kat->nama,20)}}</a>
                                    @if($kat->anak->count())
										<ul id="<?php echo strtolower($kat->nama);?>" >
										@foreach(list_category() as $kat2)
											@if ($kat2->parent==$kat->id)
												<li><a href="{{URL::to(category_url($kat2))}}" class="active" style="text-decoration: none;">{{$kat2->nama}}</a>
												</li>
											@endif
										@endforeach
										</ul>
                  ...
                  <div class="special" style="text-align: center;">
                         @foreach(vertical_banner() as $item)
                          <div><a href="{{URL::to($item->url)}}"><img width="213" src="{{URL::to(banner_image_url($item))}}" /></a></div>
                        @endforeach
                    </div>
                             ...
                             <ul id="carousel_container">
                                ...
                                <li>
                                   ...
                                   <div class="carousel_caption">
                                      ...
                                      <a href="{{product_image_url($myproduk)}}" class="btn btn-info btn-sm"><i class="icon-shopping-cart"></i> Lihat Produk</a>
                                   </div>
                                </li>
                                @endforeach
                             </ul>
