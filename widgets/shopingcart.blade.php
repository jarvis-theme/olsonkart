<a  href="{{URL::to('checkout')}}"><i class="icon-shopping-cart"></i> {{Shpcart::cart()->total_items()}} Items - {{ jadiRupiah(Shpcart::cart()->total() )}}</a>
   ...
   <div class="modal-dialog">
     <div class="modal-content">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $cart['qty']}}</td>
              <td>{{ jadiRupiah($cart['price'])}}</td>
            </tr>
            @endforeach
            <tr>
              <th></th>
              <th>Total</th>
              <th>{{ jadiRupiah(Shpcart::cart()->total() )}}</th>
            </tr>
          </tbody>
        </table>
       ...
       <div class="modal-footer">
         ...
         <button type="button" <button onclick="window.location.href='{{URL::to('checkout')}}'" class="btn btn-primary btn-small btn-block"> class="btn btn-info">Checkout</button>
       </div>
     </div><!-- /.modal-content -->
   </div><!-- /.modal-dialog -->
 </div><!-- /.modal -->
