							...
							<div class="report">
								<div class="report-bor">
									<div class="row" style="margin: 0 20px;">
										<!-- Report data starts -->
										<span>{{shortDescription($aboutUs[1]->isi,200)}}
											<a href="{{URL::to('halaman/about-us')}}"></a>
										</span>
									</div>
									<hr class="hidden-xs">
									<div class="row" style="text-align: center">
										<div class="social">
											...
											@endif
											@if($sosial->ig)
											<a target="_blank" class="linkedin" href="{{URL::to($sosial->ig)}}"><i class="icon-instagram"></i></a>
											@endif
											@if($sosial->pt)
